...
class _ProfileState extends State<Profile> {
          ...
          Center(
            child: SizedBox(
              ...
              child: Row(
                ...
                children: [
                  _itemAction(Icons.messenger_outline),
                  _itemAction(Icons.videocam_outlined),
                  _itemAction(Icons.call_outlined),
                  _itemAction(Icons.more_horiz),
                ],
              ),
            ),
          ),
  ...
  Widget _itemAction(IconData icon) {
    return Container(
